...
python3 -m unittest discover tests -v          # 期望 515 passed（14 skip：2 个 compressed fixture + 2 个 POP_TEST_PROOF 门控 + 1 个 POP_TEST_EZKL 门控 + 5 个 POP_TEST_COMPOSE 门控 + 1 个 POP_TEST_SESSION 门控 + 1 个 POP_TEST_MULTIPARTY 门控 + 1 个 POP_TEST_LLM 门控 + 1 设计内）
