...
**回归总盘**：`python3 -m unittest discover -s tests -t .` → **783 passed / 15 skipped**（2026-09-13 复跑、2026-09-16 c4 后重测、2026-09-17 `scripts/` 分组后重测、2026-09-18 R3–R14 逐项收敛后重测、2026-09-18 §5.8 步 5（demo 支路表闸门，+1 例）后重测；
